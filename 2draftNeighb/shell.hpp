double getR_aGF ( particle *particles, int *partList, double *distRow, int *distLabel, double maxShell, int N, double L ){
...
double getR_GF ( particle *particles, int *partList, double *distRow, int *distLabel, double maxShell, int N, double L ){
