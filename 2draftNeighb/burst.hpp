void burst_P_aGF ( particle *particles, int *partList, double *distRow, int *distLabel, gsl_rng *r,  int N, double L ) {
...
void burst_P_GF ( particle *particles, int *partList, double *distRow, int* distLabel, gsl_rng *r,  int N, double L ) {
