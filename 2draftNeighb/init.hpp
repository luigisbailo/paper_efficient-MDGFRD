void initPos_aGF ( particle *particles, gsl_rng *r, int N_A, int N_B, double R_A, double R_B, double D_A, double D_B, double tau_bm, double alpha, double L, double boxSizeGF ) {
...
void initPos_GF ( particle *particles, gsl_rng *r, int N_A, int N_B, double R_A, double R_B, double D_A, double D_B, double MU_BM, double MU_GF, double tau_bm, double alpha, double L, double boxSizeGF ) {
...
void initPos_BM ( particle *particles, gsl_rng *r, int N_A, int N_B, double R_A, double R_B, double D_A, double D_B, double tau_bm, double L, double boxSize) {
...
void initShell_aGF ( particle *particles, vector<vector<int>> *grid, double *distRow, int *distLabel, gsl_rng *r, int N, double tau_bm, double sqrt2TAU_BM, double maxShell, double L, int nBoxes, int *stat ) {
  ...
  for (int iPart=0; iPart<N; iPart++){
    ...
    int ilabel = iPart;
    getDist (particles, grid, distRow, distLabel, ilabel, N, L, nBoxes );
    ...
    if ( Shell > particles[iPart].R_bd ){
      ...
      polarTransf ( deltaPos, Shell, gsl_rng_uniform (r), gsl_rng_uniform (r));
...
void initShell_GF ( particle *particles, vector<vector<int>> *grid, double *distRow, int *distLabel, gsl_rng *r, int N, double tau_bm, double sqrt2TAU_BM, double maxShell, double L, int nBoxes, int *stat ) {
...
void initGridGF (particle *particles, vector <vector <int>> *grid, int NlimBox, int nBoxesGF, double boxSizeGF, int N ) {
...
void initGridBM ( particle *particles, vector <vector<int>> *grid, int NlimBox, int nBoxes, double boxSize, int N){
