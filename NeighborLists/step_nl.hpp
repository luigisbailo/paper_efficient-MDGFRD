void GFstep_aGF_nl ( particle_nl *myPart, gsl_rng *r, double R, double L ){
...
void GFstep_GF_nl ( particle_nl *myPart, gsl_rng *r, double R ){
//The shell radius "R" has been already determined with getR () and it has been already checked that the domain can be constructed
...
void BMstep_nl ( particle_nl *particles, int *partList, double *distRow, int *distLabel, gsl_rng *r, double tau_bm, double sqrt2TAU_BM, int N, double L ) {
...
void synchPart_P_aGF_nl ( particle_nl *particles, int *partList, gsl_rng *r, int N, double Tsynch, double L ) {
...
void synchPart_P_GF_nl ( particle_nl *particles, int *partList, gsl_rng *r, int N, double Tsynch, double L ) {
