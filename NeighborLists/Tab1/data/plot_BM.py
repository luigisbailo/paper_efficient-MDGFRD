...
ax1.set_xscale("log")
ax1.set_yscale("log")
ax1.errorbar(100000000/data[:,0]/data[:,0]/data[:,0]/6.022,data[:,2],yerr=data[:,4],markersize=5,color='#377EB8',marker='s',linestyle='None', label='MD-GFRD')
ax1.errorbar(100000000/data[:,0]/data[:,0]/data[:,0]/6.022,data[:,1],yerr=data[:,3],markersize=5,color='#4DAF4A',marker='o',linestyle='None', label='New scheme')	
...
ax1.set_ylim(10,200000000)
ax2.set_ylim(5,200000000)

# ax1.set_yticks([0.1,1,10,100,1000])
ax1.set_yticks([100,1000,10000,100000,1000000,10000000,100000000])
...
ax2.set_ylabel(r'$\qquad\qquad\qquad\quad Total\ number\ of\ brute\ force \ steps$',fontsize=10)
